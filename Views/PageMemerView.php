  <?php include('Views/HeaderView.php');?>
    ...
    <p class="textememer">Les « mèmes » peuvent prendre la forme d'images, de vidéos ou encore de sons. <br>
       ...
       Et plus un « mème » est personnalisé par un grand nombre d'internautes, plus il devient viral.<br>
